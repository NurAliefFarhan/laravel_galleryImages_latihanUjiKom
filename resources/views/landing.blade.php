...
<head>
    ...
    <!-- For favicon png -->
    <link rel="shortcut icon" type="image/icon" href="{{ asset('assets/landingPage/logo/favicon.png') }}" />
    ...
    <!-- bootsnav -->
    <link rel="stylesheet" href="{{asset('assets/landingPage/css/bootsnav.css"')}}">
...
<body>
            ...
            <nav class="navbar navbar-default bootsnav navbar-fixed dark no-background">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">Gallery Images</a>
                    </div><!--/.navbar-header-->
                    ...
                    {{-- <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
                      <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                          <li class="smooth-menu active"><a href="#">Home</a></li>
                          <li class="smooth-menu"><a href="{{ route('login') }}">Sign In</a></li>
                          <li class="smooth-menu"><a href="{{ route('register') }}">Sign Up</a></li>
                          <!-- Add valid links or buttons for other menu items -->
                      </ul><!--/.nav -->
                  </div><!-- /.navbar-collapse --> --}}
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="header-text">
                        <h2>Welcome <span>,</span> to <br> gallery <br> image <span>.</span> </h2>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="single-about-txt">
                            <h3>
                                Ini adlaah sebuah website gallery image, disini anda dapat melihat berbagai macam album dan membuatnya serta dapat memberikan 
                                image yang anda upload ini bsia di like dan di comment oleh user lain. Tunjukkan image mu !!
                            </h3>
                            {{-- <p>
    ...
    <script src="{{ asset('assets/landingPage/js/jquery.js') }}"></script>
    ...
    <!-- bootsnav js -->
    <script src="{{ asset('assets/landingPage/js/bootsnav.js') }}"></script>
    ...
    <!-- progressbar js -->
    <script src="{{ asset('assets/landingPage/js/progressbar.js') }}"></script>

    <!-- appear js -->
    <script src="{{ asset('assets/landingPage/js/jquery.appear.js') }}"></script>
