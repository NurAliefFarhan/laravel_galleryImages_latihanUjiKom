                    ...
                    <li>
                        ...
                        <div class="nh" :class="(selected === 'Dashboard') ? 'jc' : 'pc'">
                            <ul class="lc hg tg wm yb fb">
                                <li>
                                    <a class="nr h un lc mg sg qh gp dp ol rl zq os vq ls/5" href="{{ route('uji_kom.home') }}"
                ...
                <div class="vc tv nj xr"  style="width:100%;">
                    <div class="vc lc hg vv/2 xi yi bj wr">
                        ...
                        <div class="lc mg qg vi bj wr ql vl">
                            <div class="lc mg">
                                <div class="ob xc yd pf nh th">
                                    <img src="{{ asset('assets/img/user/user-04.png') }}" alt="avatar" class="vc yd qk rk" />
                                </div>
                                <div>
                                    <h5 class="un zn gs">
                        ...
                        @forelse ($messages as $message)
                            <div class="vd mh ip fh ql wl">
                                <div class="qf">
                                    ...
                                    <div class="qb vh hi vj yr el yl" style="width:auto;">
                                        <p>
                                            {{ $message->komentar }}
                                        </p>
                                    </div>
                                ...
                                <div>
                                    <div x-data="{openDropDown: false}" class="h">
                                        ...
                                        <div x-show="openDropDown" @click.outside="openDropDown = false"
                                            class="g m n na de eh sh so nj xr ni bj wr vk">
                                            <a class="yd sh ol ll gn mn tq js" href="{{ route('uji_kom.editMessageImages', $message->id) }}">
                                                Edit
                                            </a>
                                            <form action="{{route('uji_kom.deleteMessageImages', $message['id'])}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                        ...
                        <div class=" nj xr ti bj wr sl ql" style="position:fixed; bottom:0; width:80%;">
                            <form class="lc mg qg hh" action="{{ route('uji_kom.messageImagesPost', $images->id) }}" method="POST">
                                @csrf
            ...
            <div class="jp nh">
                <div class="vc tv nj xr"  style="width:100%;">
                    <div class="vc lc hg vv/2 xi yi bj wr">
                        ...
                        <!-- ====== Chat Box End -->
                        <div class=" nj xr ti bj wr sl ql" style="position:fixed; bottom:0; width:80%;">
                            <form class="lc mg qg hh" action="{{ route('uji_kom.messageImagesUpdate', $message_edit['id']) }}", method="POST">
                                @csrf
                                @method('PATCH')

                                <div class="h yd">
                                    <input type="text" placeholder="Type something here" name="komentar" value="{{ $message_edit->komentar }}"
                                        class="xc yd qh ni bj wr vj yr mm qm zn gs no vo fr" />
                                    <div class="g o j/2 nc -ud-translate-y-1/2 mg og ih">
                                    </div>
                                </div>
