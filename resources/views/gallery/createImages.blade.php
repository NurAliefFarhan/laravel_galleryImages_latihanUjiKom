    ...
    <div class="nh">
        ...
        <main class="gv hm hv">
            ...
            {{-- <p class="mn kb qu">
             ...
             --}}
            @if (Str::startsWith(request()->path(), 'uji_kom/createImages'))
                <div class="sk bu 2xl:ud-p-11">
                    <h4 class="tn jn zn gs xb">
                        Create Images 
                    </h4>
                    <form action="{{route('uji_kom.createImagesPost', ['id' => $album->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="form-section">
                            <div class="vb">
                            <label class="fb jc">Judul Image</label>
                            <input
                                name="judul_image" type="string" 
                            ...
                            <input type="file" name="lokasi_file" class="bj fr kr vp cr yd cg rh qi un vo xo mp op pp rp tp up wp yp zp dr lr mr" style="margin-bottom:20px;"/>
            ...
            @elseif (Str::startsWith(request()->path(), 'uji_kom/editImages'))
                <div class="sk bu 2xl:ud-p-11">
                    <h4 class="tn jn zn gs xb">
                        Update Images 
                    </h4>
                    <form action="{{ route('uji_kom.updateImages', ['id' => $images->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-section">
                            ...
                            <label class="fb jc">Judul Image</label>
                            <input
                                name="judul_image" type="string" value="{{ $images->judul_image }}"
                                class="yd qh ni bj wr tj el am vo fr ps ir"
                            />
                            </div>
                            <label class="fb jc un zn gs">
                            ...
                            <textarea
                                ...
                                placeholder="Deskripsi Image"
                                class="bj fr kr yd rh qi el yl un vo xo lr mr"
                            >{{ $images->deskripsi_image }}</textarea>
                            
                            
                            <label class="fb jc un zn gs"> Image </label>
                            <div style="display:flex; gap:20px;">
                                <input type="file" name="lokasi_file" class="bj fr kr vp cr yd cg rh qi un vo xo mp op pp rp tp up wp yp zp dr lr mr" style="margin-bottom:20px;"/>
                                <img src="{{asset($images->lokasi_file) }}" alt="image" class="yd" style="width:70px; margin-bottom:10px;"/>
                            </div>
